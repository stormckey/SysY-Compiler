...
and var_def = 
    | Single of id * init_val
    | Array of id * int_const list
[@@deriving sexp]
...
and func_f_param = 
    | Sin of btype * id
    | Arr of btype * id * int_const list
[@@deriving sexp]
...
and mul_exp =
    | UnaryExp of unary_exp
    | MulExp of mul_exp * binop * unary_exp
[@@deriving sexp]
...
and eq_exp = 
    | Rel of rel_exp
    | Eq of eq_exp * rel_exp
    | Neq of eq_exp * rel_exp
[@@deriving sexp]

and l_and_exp =
    | EQ of eq_exp
    | AND of l_and_exp * eq_exp
[@@deriving sexp]

    
and l_or_exp = 
    | And of l_and_exp
    | Or of l_or_exp * l_and_exp
[@@deriving sexp]


and either_decl_funcdef =
    | Decl of decl
    | FuncDef of func_def
[@@deriving sexp]
